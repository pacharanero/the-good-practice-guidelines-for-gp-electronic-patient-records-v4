...
| Docman | Commercial electronic document management and messaging system. Sometimes the term "Docman" is used to refer to generic document management systems |
...
| Interoperability | The facility to safely exchange electronic patient data between clinical IT systems |
| JGPITC | The Joint GP IT Committee (of the GPC and RCGP) |
| PACS | Picture Archiving and Communication System (radiology imaging — England) |
| PDS | The Personal Demographics Service (England) |
| PMIP | Pathology Messaging Improvement Project (England) |
| SCI | Scottish Care Information (SCI Store and SCI Gateway services) |
